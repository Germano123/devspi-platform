...
export default function Navbar() {
  ...
  const handleLogout = async () => {
    try {
      ...
      setError(
        "Falha ao fazer logout. Firebase pode não estar configurado corretamente."
      );
  ...
  return (
    <header className="border-b">
      <div className="container flex items-center justify-between h-16 mx-auto px-4">
        ...
        {error && (
          <div className="absolute top-16 left-0 right-0 bg-red-100 text-red-800 text-sm p-2 text-center">
            {error}
          </div>
        )}
