  ...
  const applyFilters = useCallback(() => {
    ...
    if (experienceFilter) {
      ...
      switch (experienceFilter) {
        case "less-than-1":
          result = result.filter((profile) => {
            const years = Number.parseInt(profile.tempoExperiencia.split(" ")[0])
            return years < 1
          })
          break
        case "1-3":
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-2">Conecte-se com outros desenvolvedores da comunidade de Parnaíba</p>
      </div>
                  ...
                  <Card className="overflow-hidden h-full">
                    <CardHeader className="pb-2">
                      ...
                      <CardDescription>
                        ...
                        <div className="mt-2">
                          <span className="text-sm">{profile.tempoExperiencia} de experiência</span>
                        </div>
                      </CardDescription>
                    </CardHeader>
